...
import { QuantBaseLogo } from '../components/QuantBaseLogo';
      ...
      <div className="grid min-h-screen lg:grid-cols-[minmax(420px,0.88fr)_minmax(520px,1.12fr)]">
        <section className="hidden border-r border-crypto-border bg-[#0A0F16] px-10 py-10 lg:flex lg:flex-col">
          <div className="flex items-center gap-3">
            <QuantBaseLogo className="h-12 w-12" />
            <div>
              <div className="text-lg font-semibold tracking-wide text-white">QuantBase</div>
          ...
          >
            <div className="mb-7 flex items-start justify-between gap-4">
              <div>
                ...
                <h1 className="mt-2 text-2xl font-bold text-white">登录 QuantBase</h1>
