...
`,
  ...
  },
  {
    ...
    code: `"""
===============================================================================
新手必读 — 用自己的方式写 QuantBase 策略（BaseStrategy）
===============================================================================
...
type StrategyCapitalFilter = 'all' | '100U' | '1000U' | '10000U';
    ...
    strategyApi.getPage({
      ...
      .then((result) => {
        ...
        setStrategyCapitalCounts({
          ...
          '10000U': result.capitalCounts?.['10000U'] ?? 0,
        });
      })
      .catch((err: any) => {
        if (cancelled) return;
          ...
          <div className="flex min-w-0 items-center gap-3">
            ...
            <div className="min-w-0">
              <div className="mb-1 flex items-center gap-2">
                ...
                {timeframe && <span className="text-xs text-gray-500">{timeframe}</span>}
              </div>
