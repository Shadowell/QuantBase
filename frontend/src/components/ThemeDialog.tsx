...
export default function ThemeDialog(props: ThemeDialogProps) {
  ...
  return (
    <div className="theme-dialog-backdrop fixed inset-0 z-[70] flex items-center justify-center bg-[#020617]/78 p-4 backdrop-blur-md">
      <div
        role="dialog"
        aria-modal="true"
      ...
      >
        ...
        <div className="theme-dialog-action-bar relative flex flex-col-reverse gap-3 border-t border-white/10 bg-[#111a2a]/80 px-6 py-5 sm:flex-row sm:justify-end sm:px-8">
          ...
          <button
            ...
            className={clsx(
              'h-11 w-full rounded-xl px-5 text-sm font-semibold transition-colors sm:w-auto sm:min-w-36',
              tonePrimaryBtn(tone),
            )}
          >
            {confirmLabel}
