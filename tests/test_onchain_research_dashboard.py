...
@pytest.mark.asyncio
async def test_onchain_summary_aggregates_defillama_research_data():
...
@pytest.mark.asyncio
async def test_onchain_summary_returns_explicit_waiting_state_when_defillama_unavailable():
    from app.domain.onchain.service import OnchainDomainService
